...
enum InterfaceText: String, CaseIterable, Codable, Hashable {
    ...
    case statusAudioSendBackpressure
    case setupChecklist
    case refreshStatus
    ...
    case preflightCheckingAPIKey
    case preflightAPIKeyValid
    case preflightAPIKeyMissing
    case preflightAPIKeyNotVerified
    case preflightCheckingPermissions
    case preflightPermissionsAvailable
    ...
    case underline
    case color
    case subtitleColorWhite
    case subtitleColorYellow
    case subtitleColorCyan
    case subtitleColorGreen
    case subtitleColorOrange
    ...
    case deleteTranscriptConfirmationTitle
    case deleteTranscriptConfirmationMessage
    case copyTranscript
    case delete
    ...
    case meetingNotesStarted
    case meetingNotesSource
    case meetingNotesTargetLanguage
    case meetingNotesDuration
    case noActionItemsFound
    case noMeetingNotesContent
    case connectionInterrupted
    case connectionReconnecting
    case connectionRecovered
    case connectionReconnectFailed
    case connectionProviderError
    case connectionSocketOpened
    case connectionSessionReady
    case connectionDisconnected
    case connectionSocketClosed
    case connectionSendFailed
    case connectionServerError
    case connectionParseFailed
...
enum InterfaceLanguage: String, CaseIterable, Codable, Identifiable, Hashable {
    ...
    private static let englishText: [InterfaceText: String] = [
        ...
        .statusAudioSendBackpressure: "Audio send queue is full; dropping live audio chunks to keep latency bounded.",
        ...
        .preflightCheckingAPIKey: "Checking API key",
        .preflightAPIKeyValid: "API key is valid",
        .preflightAPIKeyMissing: "API key is missing",
        .preflightAPIKeyNotVerified: "API key was not verified",
        .preflightCheckingPermissions: "Checking permissions",
        .preflightPermissionsAvailable: "Required permissions are available",
        ...
        .subtitleColorCyan: "Cyan",
        .subtitleColorGreen: "Green",
        .subtitleColorOrange: "Orange",
        ...
        .deleteTranscriptConfirmationTitle: "Delete transcript?",
        .deleteTranscriptConfirmationMessage: "This will permanently delete the transcript session %@.",
        ...
        .meetingNotesStarted: "Started",
        .meetingNotesSource: "Source",
        .meetingNotesTargetLanguage: "Target Language",
        .meetingNotesDuration: "Duration",
        .noActionItemsFound: "No action items found",
        .noMeetingNotesContent: "No content",
        ...
        .connectionSocketOpened: "Gemini socket opened",
        .connectionSessionReady: "Gemini session ready",
        .connectionDisconnected: "Connection disconnected: %@",
        .connectionSocketClosed: "Connection closed: %@",
        .connectionSendFailed: "Audio send failed: %@",
        .connectionServerError: "Gemini error: %@",
        .connectionParseFailed: "Could not read Gemini response: %@",
    ...
    private static let translations: [InterfaceLanguage: [InterfaceText: String]] = [
        ...
        .simplifiedChinese: englishText.merging([
            ...
            .statusAudioSendBackpressure: "音频发送队列已满，正在丢弃实时音频片段以保持低延迟。",
            ...
            .preflightCheckingAPIKey: "正在检查 API 密钥",
            .preflightAPIKeyValid: "API 密钥有效",
            .preflightAPIKeyMissing: "缺少 API 密钥",
            .preflightAPIKeyNotVerified: "API 密钥未完成验证",
            .preflightCheckingPermissions: "正在检查权限",
            .preflightPermissionsAvailable: "所需权限已可用",
            ...
            .underline: "下划线",
            .color: "颜色",
            .subtitleColorWhite: "白色",
            .subtitleColorYellow: "黄色",
            .subtitleColorCyan: "青色",
            .subtitleColorGreen: "绿色",
            .subtitleColorOrange: "橙色",
            ...
            .deleteTranscriptConfirmationTitle: "删除转录？",
            .deleteTranscriptConfirmationMessage: "这将永久删除转录会话“%@”。",
            .copyTranscript: "复制转录",
            .delete: "删除",
            ...
            .meetingNotesStarted: "开始时间",
            .meetingNotesSource: "来源",
            .meetingNotesTargetLanguage: "目标语言",
            .meetingNotesDuration: "时长",
            .noActionItemsFound: "未发现待办事项",
            .noMeetingNotesContent: "暂无内容",
            ...
            .connectionSocketOpened: "Gemini 连接已打开",
            .connectionSessionReady: "Gemini 会话已就绪",
            .connectionDisconnected: "连接已断开：%@",
            .connectionSocketClosed: "连接已关闭：%@",
            .connectionSendFailed: "音频发送失败：%@",
            .connectionServerError: "Gemini 错误：%@",
            .connectionParseFailed: "无法读取 Gemini 响应：%@",
        ...
        .japanese: englishText.merging([
            ...
            .statusAudioSendBackpressure: "音声送信キューがいっぱいです。低遅延を保つためライブ音声チャンクを破棄しています。",
            ...
            .glossaryEmptyStateTitle: "用語はまだありません",
            .glossaryEmptyStateMessage: "手動で追加するか、公開用語ソースをダウンロードするか、自分の用語ファイルをインポートできます。",
            .glossaryNoSearchResults: "「%@」に一致する用語はありません",
            ...
            .preflightCheckingAPIKey: "APIキーを確認中",
            .preflightAPIKeyValid: "APIキーは有効です",
            .preflightAPIKeyMissing: "APIキーが未入力です",
            .preflightAPIKeyNotVerified: "APIキーを確認できませんでした",
            .preflightCheckingPermissions: "権限を確認中",
            .preflightPermissionsAvailable: "必要な権限は利用可能です",
            ...
            .underline: "下線",
            .color: "色",
            .subtitleColorWhite: "白",
            .subtitleColorYellow: "黄",
            .subtitleColorCyan: "シアン",
            .subtitleColorGreen: "緑",
            .subtitleColorOrange: "オレンジ",
            ...
            .deleteTranscriptConfirmationTitle: "文字起こしを削除しますか？",
            .deleteTranscriptConfirmationMessage: "文字起こしセッション「%@」を完全に削除します。",
            ...
            .meetingNotesStarted: "開始",
            .meetingNotesSource: "ソース",
            .meetingNotesTargetLanguage: "ターゲット言語",
            .meetingNotesDuration: "所要時間",
            .noActionItemsFound: "アクション項目はありません",
            .noMeetingNotesContent: "内容はありません",
            ...
            .connectionSocketOpened: "Gemini ソケットを開きました",
            .connectionSessionReady: "Gemini セッションの準備ができました",
            .connectionDisconnected: "接続が切断されました：%@",
            .connectionSocketClosed: "接続が閉じられました：%@",
            .connectionSendFailed: "音声の送信に失敗しました：%@",
            .connectionServerError: "Gemini エラー：%@",
            .connectionParseFailed: "Gemini 応答を読み取れませんでした：%@",
        ...
        .korean: englishText.merging([
            ...
            .statusAudioSendBackpressure: "오디오 전송 대기열이 가득 차 지연을 줄이기 위해 실시간 오디오 조각을 버립니다.",
            ...
            .glossaryEmptyStateTitle: "아직 용어가 없습니다",
            .glossaryEmptyStateMessage: "직접 추가하거나 공개 용어 소스를 다운로드하거나 용어 파일을 가져오세요.",
            .glossaryNoSearchResults: "“%@”와 일치하는 용어가 없습니다",
            ...
            .preflightCheckingAPIKey: "API 키 확인 중",
            .preflightAPIKeyValid: "API 키가 유효합니다",
            .preflightAPIKeyMissing: "API 키가 없습니다",
            .preflightAPIKeyNotVerified: "API 키를 확인하지 못했습니다",
            .preflightCheckingPermissions: "권한 확인 중",
            .preflightPermissionsAvailable: "필요한 권한을 사용할 수 있습니다",
            ...
            .underline: "밑줄",
            .color: "색상",
            .subtitleColorWhite: "흰색",
            .subtitleColorYellow: "노란색",
            .subtitleColorCyan: "청록색",
            .subtitleColorGreen: "초록색",
            .subtitleColorOrange: "주황색",
            ...
            .deleteTranscriptConfirmationTitle: "전사 기록을 삭제할까요?",
            .deleteTranscriptConfirmationMessage: "전사 세션 %@을 영구 삭제합니다.",
            ...
            .meetingNotesStarted: "시작",
            .meetingNotesSource: "소스",
            .meetingNotesTargetLanguage: "대상 언어",
            .meetingNotesDuration: "기간",
            .noActionItemsFound: "할 일을 찾지 못했습니다",
            .noMeetingNotesContent: "내용 없음",
            ...
            .connectionSocketOpened: "Gemini 소켓이 열렸습니다",
            .connectionSessionReady: "Gemini 세션 준비 완료",
            .connectionDisconnected: "연결이 끊겼습니다: %@",
            .connectionSocketClosed: "연결이 닫혔습니다: %@",
            .connectionSendFailed: "오디오 전송 실패: %@",
            .connectionServerError: "Gemini 오류: %@",
            .connectionParseFailed: "Gemini 응답을 읽을 수 없습니다: %@",
        ...
        .spanish: englishText.merging([
            ...
            .statusAudioSendBackpressure: "La cola de envío de audio está llena; se descartan fragmentos de audio en vivo para mantener baja la latencia.",
            ...
            .glossaryEmptyStateTitle: "Aún no hay términos en el glosario",
            .glossaryEmptyStateMessage: "Añade un término manualmente, descarga una fuente terminológica pública o importa tu propio archivo de glosario.",
            .glossaryNoSearchResults: "No hay términos que coincidan con \"%@\"",
            ...
            .preflightCheckingAPIKey: "Comprobando clave API",
            .preflightAPIKeyValid: "La clave API es válida",
            .preflightAPIKeyMissing: "Falta la clave API",
            .preflightAPIKeyNotVerified: "No se verificó la clave API",
            .preflightCheckingPermissions: "Comprobando permisos",
            .preflightPermissionsAvailable: "Los permisos necesarios están disponibles",
            ...
            .underline: "Subrayado",
            .color: "Color",
            .subtitleColorWhite: "Blanco",
            .subtitleColorYellow: "Amarillo",
            .subtitleColorCyan: "Cian",
            .subtitleColorGreen: "Verde",
            .subtitleColorOrange: "Naranja",
            ...
            .deleteTranscriptConfirmationTitle: "¿Eliminar transcripción?",
            .deleteTranscriptConfirmationMessage: "Se eliminará permanentemente la sesión de transcripción %@.",
            ...
            .meetingNotesStarted: "Inicio",
            .meetingNotesSource: "Fuente",
            .meetingNotesTargetLanguage: "Idioma de destino",
            .meetingNotesDuration: "Duración",
            .noActionItemsFound: "No se encontraron tareas",
            .noMeetingNotesContent: "Sin contenido",
            ...
            .connectionSocketOpened: "Socket de Gemini abierto",
            .connectionSessionReady: "Sesión de Gemini lista",
            .connectionDisconnected: "Conexión desconectada: %@",
            .connectionSocketClosed: "Conexión cerrada: %@",
            .connectionSendFailed: "Error al enviar audio: %@",
            .connectionServerError: "Error de Gemini: %@",
            .connectionParseFailed: "No se pudo leer la respuesta de Gemini: %@",
        ...
        .french: englishText.merging([
            ...
            .statusAudioSendBackpressure: "La file d’envoi audio est pleine ; des fragments audio en direct sont ignorés pour garder une faible latence.",
            ...
            .glossaryEmptyStateTitle: "Aucun terme pour le moment",
            .glossaryEmptyStateMessage: "Ajoutez un terme manuellement, téléchargez une source terminologique publique ou importez votre propre fichier de glossaire.",
            .glossaryNoSearchResults: "Aucun terme ne correspond à « %@ »",
            ...
            .preflightCheckingAPIKey: "Vérification de la clé API",
            .preflightAPIKeyValid: "La clé API est valide",
            .preflightAPIKeyMissing: "La clé API est manquante",
            .preflightAPIKeyNotVerified: "La clé API n’a pas été vérifiée",
            .preflightCheckingPermissions: "Vérification des permissions",
            .preflightPermissionsAvailable: "Les permissions requises sont disponibles",
            ...
            .underline: "Souligné",
            .color: "Couleur",
            .subtitleColorWhite: "Blanc",
            .subtitleColorYellow: "Jaune",
            .subtitleColorCyan: "Cyan",
            .subtitleColorGreen: "Vert",
            .subtitleColorOrange: "Orange",
            ...
            .deleteTranscriptConfirmationTitle: "Supprimer la transcription ?",
            .deleteTranscriptConfirmationMessage: "La session de transcription « %@ » sera supprimée définitivement.",
            ...
            .meetingNotesStarted: "Début",
            .meetingNotesSource: "Source",
            .meetingNotesTargetLanguage: "Langue cible",
            .meetingNotesDuration: "Durée",
            .noActionItemsFound: "Aucune action trouvée",
            .noMeetingNotesContent: "Aucun contenu",
            ...
            .connectionSocketOpened: "Socket Gemini ouverte",
            .connectionSessionReady: "Session Gemini prête",
            .connectionDisconnected: "Connexion interrompue : %@",
            .connectionSocketClosed: "Connexion fermée : %@",
            .connectionSendFailed: "Échec de l’envoi audio : %@",
            .connectionServerError: "Erreur Gemini : %@",
            .connectionParseFailed: "Impossible de lire la réponse Gemini : %@",
        ...
        .german: englishText.merging([
            ...
            .statusAudioSendBackpressure: "Die Audio-Sendewarteschlange ist voll; Live-Audiosegmente werden verworfen, um die Latenz niedrig zu halten.",
            ...
            .glossaryEmptyStateTitle: "Noch keine Glossarbegriffe",
            .glossaryEmptyStateMessage: "Fügen Sie einen Begriff manuell hinzu, laden Sie eine öffentliche Terminologiequelle herunter oder importieren Sie eine eigene Glossardatei.",
            .glossaryNoSearchResults: "Keine Glossarbegriffe entsprechen „%@“",
            ...
            .preflightCheckingAPIKey: "API-Schlüssel wird geprüft",
            .preflightAPIKeyValid: "API-Schlüssel ist gültig",
            .preflightAPIKeyMissing: "API-Schlüssel fehlt",
            .preflightAPIKeyNotVerified: "API-Schlüssel wurde nicht geprüft",
            .preflightCheckingPermissions: "Berechtigungen werden geprüft",
            .preflightPermissionsAvailable: "Erforderliche Berechtigungen sind verfügbar",
            ...
            .color: "Farbe",
            .subtitleColorWhite: "Weiß",
            .subtitleColorYellow: "Gelb",
            .subtitleColorCyan: "Cyan",
            .subtitleColorGreen: "Grün",
            .subtitleColorOrange: "Orange",
            .subtitleColorPink: "Pink",
            ...
            .deleteTranscriptConfirmationTitle: "Transkript löschen?",
            .deleteTranscriptConfirmationMessage: "Die Transkript-Sitzung %@ wird dauerhaft gelöscht.",
            ...
            .meetingNotesStarted: "Start",
            .meetingNotesSource: "Quelle",
            .meetingNotesTargetLanguage: "Zielsprache",
            .meetingNotesDuration: "Dauer",
            .noActionItemsFound: "Keine Aufgaben gefunden",
            .noMeetingNotesContent: "Kein Inhalt",
            ...
            .connectionSocketOpened: "Gemini-Socket geöffnet",
            .connectionSessionReady: "Gemini-Sitzung bereit",
            .connectionDisconnected: "Verbindung getrennt: %@",
            .connectionSocketClosed: "Verbindung geschlossen: %@",
            .connectionSendFailed: "Audio konnte nicht gesendet werden: %@",
            .connectionServerError: "Gemini-Fehler: %@",
            .connectionParseFailed: "Gemini-Antwort konnte nicht gelesen werden: %@",
        ...
        .vietnamese: englishText.merging([
            ...
            .statusAudioSendBackpressure: "Hàng đợi gửi âm thanh đã đầy; đang bỏ các đoạn âm thanh trực tiếp để giữ độ trễ thấp.",
            ...
            .glossaryEmptyStateTitle: "Chưa có thuật ngữ nào",
            .glossaryEmptyStateMessage: "Thêm thuật ngữ thủ công, tải nguồn thuật ngữ công khai hoặc nhập tệp bảng thuật ngữ của bạn.",
            .glossaryNoSearchResults: "Không có thuật ngữ nào khớp với \"%@\"",
            ...
            .preflightCheckingAPIKey: "Đang kiểm tra khóa API",
            .preflightAPIKeyValid: "Khóa API hợp lệ",
            .preflightAPIKeyMissing: "Thiếu khóa API",
            .preflightAPIKeyNotVerified: "Chưa xác minh được khóa API",
            .preflightCheckingPermissions: "Đang kiểm tra quyền",
            .preflightPermissionsAvailable: "Các quyền cần thiết đã sẵn sàng",
            ...
            .underline: "Gạch chân",
            .color: "Màu",
            .subtitleColorWhite: "Trắng",
            .subtitleColorYellow: "Vàng",
            .subtitleColorCyan: "Xanh lơ",
            .subtitleColorGreen: "Xanh lá",
            .subtitleColorOrange: "Cam",
            ...
            .deleteTranscriptConfirmationTitle: "Xóa bản chép lời?",
            .deleteTranscriptConfirmationMessage: "Thao tác này sẽ xóa vĩnh viễn phiên chép lời %@.",
            ...
            .meetingNotesStarted: "Bắt đầu",
            .meetingNotesSource: "Nguồn",
            .meetingNotesTargetLanguage: "Ngôn ngữ đích",
            .meetingNotesDuration: "Thời lượng",
            .noActionItemsFound: "Không tìm thấy việc cần làm",
            .noMeetingNotesContent: "Chưa có nội dung",
            ...
            .connectionSocketOpened: "Đã mở socket Gemini",
            .connectionSessionReady: "Phiên Gemini đã sẵn sàng",
            .connectionDisconnected: "Kết nối đã ngắt: %@",
            .connectionSocketClosed: "Kết nối đã đóng: %@",
            .connectionSendFailed: "Gửi âm thanh thất bại: %@",
            .connectionServerError: "Lỗi Gemini: %@",
            .connectionParseFailed: "Không thể đọc phản hồi Gemini: %@",
